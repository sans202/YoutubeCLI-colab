...
class YoutubeCreatorPageState(YoutubeStateBase):
    ...
    def init_state(self, **kwargs):
        self._set_fetch_request(self._client.search(), ['part', 'type', 'channelId'])

        kwargs['channelId'] = kwargs.pop('creator_id', None)
        kwargs['part'] = 'snippet'
        kwargs['type'] = 'video'
